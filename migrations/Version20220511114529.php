 ...
 */
final class Version20220511114529 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE event (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(64) NOT NULL, content LONGTEXT NOT NULL, content_2 LONGTEXT NOT NULL, link_video VARCHAR(255) DEFAULT NULL, link_sound VARCHAR(255) DEFAULT NULL, picture_1 VARCHAR(255) DEFAULT NULL, picture_2 VARCHAR(255) DEFAULT NULL, picture_3 VARCHAR(255) DEFAULT NULL, time TIME NOT NULL, age LONGTEXT DEFAULT NULL, technique_1 LONGTEXT NOT NULL, technique_2 LONGTEXT NOT NULL, technique_3 LONGTEXT NOT NULL, bonus_1 LONGTEXT DEFAULT NULL, bonus_2 LONGTEXT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
